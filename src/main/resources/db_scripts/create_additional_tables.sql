...
(
    ...
    VEHICLE_TASK_ID             UUID,
    PLACE_FACT_ID               UUID,
    PLACE_FACT_LAT              float,
    PLACE_FACT_LON              float,
    ORDER_ID                    UUID,
    CUR_VEHICLE_LAT             float,
    CUR_VEHICLE_LON             float,
    ORDER_PLACE_START_LAT       float,
    ORDER_PLACE_START_LON       float,
    ORDER_PLACE_FINISH_LAT      float,
    ORDER_PLACE_FINISH_LON      float,
    CUR_VEHICLE_DATE            timestamp,
    DISTANCE_TO_FINISH_PLACE    float,
    REGION_START_ID             UUID,
    TYPE_                       varchar(10),
